        ...
        <div class="grid wide order">
                ...
                <div class="row">
                    <div class="col l-3 m-3 c-3">
                        <div class="selected__left">
                            <img src="img/anh4.jpg" alt="" class="selected-img">
                        </div>
                    </div>
            ...
            <div class="slider__order-delivery">
                ...
                <form action class="deliverydetails">
                    ...
                    <input type="text" name="" required id="" placeholder="E.g. LeDuyThien" class="delivery-input">
                    <span class="delivery__title">Phone Number</span>
                    <input type="number" name="" required id="" placeholder="E.g. 0395xxxxx" class="delivery-input">
                    <span class="delivery__title">Email</span>
                    <input type="email" name="" required id="" placeholder="E.g. LeDuyThien@gmail.com"

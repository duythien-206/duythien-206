                ...
                <div class="row">
                    ...
                    <div class="slider col l-4 m-4 c-6">
                        <div class="slider__images-title">
                            <img src="img/anh6.jpg" alt="" class="slider__img">
                            <h4 class="slider__img-text">Pizza</h4>
                        </div>
                    </div>
                    <div class="slider col l-4 m-4 c-6">
                        <div class="slider__images-title">
                            <img src="img/anh1.jpg" alt="" class="slider__img">
                            <h4 class="slider__img-text">Burder</h4>
                        </div>
                    </div>
                    <div class="slider col l-4 m-4 c-6">
                        <div class="slider__images-title">
                            <img src="img/anh5.jpg" alt="" class="slider__img">
                ...
                <div class="grid wide">
                    <div class="row">
                        ...
                        <div class="col l-6 m-6 c-12">
                            <div class="slider__foodmenu-block">
                                <div class="col l-3 m-3 c-3">
                                    <img src="img/anh4.jpg" alt="" class="foodmenu-img">
                                </div>
                        ...
                        <div class="col l-6 m-6 c-12">
                            <div class="slider__foodmenu-block">
                                <div class="col l-3 m-3 c-3">
                                    <img src="img/anh2.jpg" alt="" class="foodmenu-img">
                                </div>
                                <div class="col l-9 m-9 c-9">
                                    <div class="slider__foodmenu-right">
                                        <h4 class="slider__foodmenu-title">Food Title</h4>
                        ...
                        <div class="col l-6 m-6 c-12">
                            <div class="slider__foodmenu-block">
                                <div class="col l-3 m-3 c-3">
                                    <img src="img/anh3.jpg" alt="" class="foodmenu-img">
                                </div>
                                <div class="col l-9 m-9 c-9">
                                    <div class="slider__foodmenu-right">
                                        <h4 class="slider__foodmenu-title">Food Title</h4>
